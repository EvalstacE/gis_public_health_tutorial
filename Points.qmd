...
![Point-Process](_images/points_events.png){.lightbox}

![Point-Referenced](_images/geostats_points.png){.lightbox}
...
![Point-Process](_images/point_intensity_circle.png){.lightbox}

![Point-Process](_images/point_intensity_square.png){.lightbox}
