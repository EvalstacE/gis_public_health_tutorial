...
# Bring in shapefile
income <- st_read("Shapefiles/income", "income")
...
![Classifying Data](_images/classify_1.png){.lightbox}
...
![create breaks](_images\breaks1.png){.lightbox}


![create breaks](_images\breaks2.png){.lightbox}
