...
epsg_codes <- read.csv("_info_tables/epsg_codes.csv")
...
epsg_table <- epsg_codes %>%
  ...
  kable_styling(
    bootstrap_options = c("striped", "hover", "condensed"), # Adds banded rows (striped)
    full_width = TRUE)
...
![Albers Equal Area Projection](_maps\aea_projected.png){.lightbox}
