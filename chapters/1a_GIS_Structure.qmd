...
![Tobler's First Law of Geography](..\images\tobler_law.png){.lightbox}
...
* **Selection**
    ...
    ![Selection Generalization](..\images\selection.png){.lightbox}
...
* **Simplification**
    ...
    ![Selection Generalization](..\images\simplify.png){.lightbox}
...
* **Displacement**
    ...
    + resolves conflicts like overlaps by repositioning features
      ![Displacement Generalization](..\images\displace.png){.lightbox}
...
* **Smoothing**
    ...
    ![Selection Generalization](..\images\smooth.png){.lightbox}
...
![Vectors vs Rasters](..\images\vectors_rasters.png){.lightbox}

```{r, echo = FALSE}

vector_raster <- read.csv(file = here::here("info_tables/rasters_vectors.csv"))
