...
![Geographic Coordinate Systems](..\images\CRS.png){.lightbox}
...
![Geographic Coordinate Systems](..\images\GCS_visual.png){.lightbox width=50% fig-align="left"} 


```{r, echo = FALSE}

lat_long <- read.csv(file = here::here("info_tables/Lat_vs_Long.csv"))
...
datums <- read.csv(file = here::here("info_tables/Local_Geocentric_Datums.csv"))
...
PCS_types <- read.csv(here::here("info_tables/projection_types.csv"))
...
::: {layout-ncol=3}
![Planar](..\images\planar.png){.lightbox}

![Cylindrical](..\images\cylindrical.png){.lightbox}

![Conical](..\images\conical.png){.lightbox}
...
![Conical](..\images\US_UTM_zones.png){.lightbox}
