...
To interact with the Census Bureau’s API, we use the `tidycensus` library. This requires an API key.

Request a free key from: **http://api.census.gov/data/key_signup.html**
...
leaflet_zindex <- read.csv(file = here::here("info_tables/leaflet_zindex.csv"))

leaflet_zindex_table <- leaflet_zindex %>%
  kbl(caption = "Leaflet's Default Reserved Z-Index Panes",
      align = "ccl") %>%
